...
LibStub("LibPeriodicTable-3.1"):AddData("Consumable", gsub("$Rev$", "(%d+)", function(n) return n+90000 end), {
	...
	["Consumable.Food.Buff.Other"]="6657,12217,33866,42997,43001,43491,43492,43488,43490,33924,43572",
