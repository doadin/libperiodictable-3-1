...
LibStub("LibPeriodicTable-3.1"):AddData("Consumable", gsub("$Rev$", "(%d+)", function(n) return n+90000 end), {
	...
	["Consumable.Buff.Other.Self"]="3387,3823,3828,5996,5634,6372,8529,8956,9233,9154,9172,9197,10592,13506,43090,43094,43134,43141,43462,43470,43472,43473",
	...
	["Consumable.Buff.Water Breathing"]="34076:3,37265:10,24421:30",
